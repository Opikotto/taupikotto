...
<footer className="p-4 bg-white sm:p-6 dark:bg-white ">
    ...
    <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 container mx-auto"></hr>
    <div className="sm:flex sm:items-center sm:justify-between container mx-auto">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-blue-300">
